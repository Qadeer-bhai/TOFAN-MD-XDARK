...
> https://github.com/Qadeer-bhai/TOFAN-MD-XDARK
╭──━━━━═════════━━━━⦿
┃ ❂━━━════➳════━━━━❂
...
❂━━━════──➳──════━━━❂`;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "I am *TOFAN Md Xdark*, Developed By Qadeer Khan" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
